...
class TestBaseOperation(unittest.TestCase):
    ...
    def test_sum(self, target_device_idx, xp):
        ...
        value1 = BaseValue(xp.array([1]), target_device_idx=target_device_idx)
        value2 = BaseValue(xp.array([2]), target_device_idx=target_device_idx)
    ...
    def test_mul(self, target_device_idx, xp):
        ...
        value1 = BaseValue(xp.array([2]), target_device_idx=target_device_idx)
        value2 = BaseValue(xp.array([3]), target_device_idx=target_device_idx)
        value1.generation_time = 1
        value2.generation_time = 1
    ...
    def test_div(self, target_device_idx, xp):
        ...
        value1 = BaseValue(xp.array([6.0]), target_device_idx=target_device_idx)
        value2 = BaseValue(xp.array([3.0]), target_device_idx=target_device_idx)
        value1.generation_time = 1
        value2.generation_time = 1
    ...
    def test_concat(self, target_device_idx, xp):
        ...
        value1 = BaseValue(xp.array([1, 2]), target_device_idx=target_device_idx)
        value2 = BaseValue(xp.array([3.0]), target_device_idx=target_device_idx)
        value1.generation_time = 1
        value2.generation_time = 1
    ...
    def test_that_value1_is_not_overwritten(self, target_device_idx, xp):
        ...
        value1 = BaseValue(xp.array([1.0]), target_device_idx=target_device_idx)
        value1.generation_time = 1
        value2 = BaseValue(xp.array([2.0]), target_device_idx=target_device_idx)
        value2.generation_time = 1
